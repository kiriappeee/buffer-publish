...
+-- components/ # presentational components
    +-- EditEmail # component that is only used in the package
...
```js
import EditEmail, { actions, actionTypes, middleware, reducer } from '@bufferapp/edit-email';
```
...
#### components/EditEmail/index.jsx
...
#### components/EditEmail/story.jsx
